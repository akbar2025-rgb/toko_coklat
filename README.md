...
# Install PHP 7.4
sudo apt-get install php7.4 php7.4-mysql php7.4-cli php7.4-common
...
### 4. Download Bootstrap Offline

Download dan ekstrak ke folder `assets/`:
...
```apache
<VirtualHost *:80>
    ServerName tokoclat.local
    DocumentRoot /var/www/html/toko_coklat/views
    
    <Directory /var/www/html/toko_coklat>
